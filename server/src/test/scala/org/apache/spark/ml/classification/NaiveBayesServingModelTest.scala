...
object NaiveBayesServingModelTest {
  ...
  def trans(model: NaiveBayesModel): SDFrame = {
    val transModel = ModelUtils.transModel(model).asInstanceOf[NaiveBayesServingModel]
