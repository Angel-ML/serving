...
import org.apache.spark.ml.transformer.ServingPipelineModel
import org.apache.spark.ml.feature.utils.ModelUtils
import org.apache.spark.sql.SparkSession
import org.apache.spark.sql.types.{StructField, StructType}

object DecisionTreeRegressionServingModelTest {
  ...
  def trans(model: PipelineModel): SDFrame = {
    val transModel = ModelUtils.transModel(model).asInstanceOf[ServingPipelineModel]
